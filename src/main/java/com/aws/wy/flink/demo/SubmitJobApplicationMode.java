...
//        String FLINK_HOME = "/home/hadoop/flink-1.12.2";
        String FLINK_HOME = "/usr/lib/flink";
        String FLINK_CONF_DIR = FLINK_HOME + "/conf";

        //存放flink集群相关的jar包目录
        String hdfs = "hdfs://ip-172-31-18-218.ap-southeast-1.compute.internal:8020/";
        String flinkLibs = hdfs + "/usr/lib/flink/lib";
...
//        String flinkUserJars = hdfs + "/flink/userjars";
        ...
        String userJarPath ="/usr/lib/flink/examples/streaming/WordCount.jar";
...
//        String mainClass = "me.arnu.flink.demo.Main";
        ...
        String flinkDistJar = "/usr/lib/flink/lib/flink-dist_2.11-1.12.1.jar";
